...
import { Shirt, Fence, Users, Heart, MapPin, Handshake, ArrowRight, Phone } from 'lucide-react';
    ...
    <>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-24 overflow-hidden bg-accent">
        <div
          ...
          style={{ backgroundImage: 'url(/team-wide.jpg)' }}
        />
        <div className="absolute inset-0 bg-gradient-to-b from-accent/70 via-accent/60 to-accent/85" />
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollTriggerFadeIn>
            <h1 className="text-4xl md:text-6xl font-bold text-accent-foreground mb-6 text-balance leading-tight drop-shadow-lg">
              Werden Sie Partner des FC Lahr-West
            </h1>
            <p className="text-lg md:text-xl text-accent-foreground/90 max-w-2xl mx-auto leading-relaxed mb-10 drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="bg-white/10 backdrop-blur border-white text-white hover:bg-white/20 hover:text-white text-lg px-8"
              >
                <a href="tel:+491749804514">
                  <Phone className="mr-2 h-5 w-5" /> 0174 980 45 14
                </a>
              </Button>
            </div>
          </ScrollTriggerFadeIn>
      ...
      <section id="anfrage" className="py-20 md:py-24 bg-background scroll-mt-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ScrollTriggerFadeIn delay={0.25}>
            <div className="mt-10 bg-muted border border-border rounded-2xl p-6 text-center">
              <p className="text-muted-foreground mb-4">
                Lieber direkt sprechen? Rufen Sie uns einfach an – wir klären alles Weitere
                unkompliziert am Telefon.
              </p>
