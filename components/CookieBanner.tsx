...
export default function CookieBanner() {
  ...
  useEffect(() => {
    ...
    const handleStorage = (e: StorageEvent) => {
      if (e.key === STORAGE_KEY && e.newValue && !configOpen) {
        try {
          const parsed = JSON.parse(e.newValue) as StoredConsent;
    ...
    return () => {
      window.removeEventListener('openCookieBanner', handleOpen);
    ...
    <>
      ...
      <AnimatePresence>
        {visible && !configOpen && (
          ...
          >
            <div className="max-w-5xl mx-auto bg-background border border-border rounded-2xl shadow-2xl p-5 md:p-6 pointer-events-auto">
